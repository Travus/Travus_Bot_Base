...
def setup(bot: func.TravusBotBase):
    ...
    bot.add_command_help(CoreFunctionalityCog.prefix, "Core", {"owner": True}, ["$", "bot!", "bot ?", "remove"])
    bot.add_command_help(CoreFunctionalityCog.module, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["list", "load", "unload", "reload"])
    bot.add_command_help(CoreFunctionalityCog.module_list, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, [""])
    bot.add_command_help(CoreFunctionalityCog.module_load, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["fun", "economy"])
    bot.add_command_help(CoreFunctionalityCog.module_unload, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["fun", "economy"])
    bot.add_command_help(CoreFunctionalityCog.module_reload, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["fun", "economy"])
    bot.add_command_help(CoreFunctionalityCog.default, "Core", {"owner": True}, ["list", "add", "remove"])
    bot.add_command_help(CoreFunctionalityCog.default_list, "Core", {"owner": True}, [""])
    bot.add_command_help(CoreFunctionalityCog.default_add, "Core", {"owner": True}, ["fun", "economy"])
    bot.add_command_help(CoreFunctionalityCog.default_remove, "Core", {"owner": True}, ["fun", "economy"])
    bot.add_command_help(CoreFunctionalityCog.delete_messages, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["enable", "y", "disable", "n"])
    bot.add_command_help(CoreFunctionalityCog.command, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["enable", "disable", "show", "hide"])
    bot.add_command_help(CoreFunctionalityCog.command_enable, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["balance", "pay"])
    bot.add_command_help(CoreFunctionalityCog.command_disable, "Core", {"guild_only": True, "perms": ["Administrator: Yes"]}, ["balance", "pay"])
